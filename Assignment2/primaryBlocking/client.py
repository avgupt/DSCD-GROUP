...
class Client:
    ...
    def write(self, file_name, file_content, server_path):
        ...
        with grpc.insecure_channel(server_path, options=(('grpc.enable_http_proxy', 0),)) as channel:
            ...
            response = stub.write(server_pb2.WriteRequest(file_name=file_name, file_content=file_content, uuid=file_uuid, is_write_from_client=1))
    ...
    def update(self, file_name, file_content, uuid, server_path):
        with grpc.insecure_channel(server_path, options=(('grpc.enable_http_proxy', 0),)) as channel:
            stub = server_pb2_grpc.ServerServiceStub(channel)
...
#                 myClient.write(file_name, file_content, server_name)
...
#                 file_content = input("Enter file content: ")
#                 myClient.update(file_name, file_content, file_uuid, server_name)
